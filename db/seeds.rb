...
g1 = Game.create(name: 'Fluffy Gelato', highscore: "Strawby has escaped the the Gelato Shop in search of a better home. Strangely enough, Strawby's escape path requires her to fly between pipes. Strangely enough, Gelatos can fly. Tap the window or tap the spacebar to keep the Gelato in the air. Fly through as many pipes as possible without crashing.")
